...
目前主要从事智能超表面、凸优化理论、人工智能算法在无线通信和感知领域应用的相关研究。在通信领域顶级期刊IEEE TWC、TCOM和顶级会议IEEE ICC、ICASSP等发表学术论文近30篇，其中第一/共一作者论文15篇。2篇论文入选**🏆ESI高被引论文**（一作），1篇论文位列**IEEE CL年度最受欢迎论文TOP 2**（一作），4篇论文分别位列**IEEE TVT、WCL、CL月度最受欢迎论文TOP 50**（1篇一作、2篇共一、1篇第二）。授权专利3项。担任2026 PIMRC TPC Chair；多次担任IEEE ICC、Globecom、WCNC等国际会议TPC Member；常年担任IEEE JSAC、TWC、TCOM、WCM、TIFS、TCCN、TVT、TITS、IOTJ、WCL、CL等十余家国际期刊审稿人。 
