...
.pub-list > li {
    ...
    /* Line spacing within each publication */
    line-height: 1.65;
...
<span class="journal-name">IEEE Internet of Things Journal</span>.
<span class="paper-info">(Student First Author, Major Revision, JCR Q1, IF = 8.7)</span>
</li>
...
<span class="paper-info">(Student First Author, Major Revision, JCR Q2, IF = 3.0)</span>
</li>
...
<span class="journal-name">IEEE Internet of Things Journal</span>.
<span class="paper-info">(Student First Author, Under Review, JCR Q1, IF = 8.7)</span>
</li>
...
<span class="paper-info">(EI, Important International Conference in Communications)</span>
...
<span class="paper-info">(EI, IEEE Flagship Conference)</span>
