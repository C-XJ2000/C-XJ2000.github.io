...
He has been granted three patents. He serves as the **first young editorial board member of 《China Communications》** and a **TPC Chair for IEEE PIMRC 2026**. He also has served multiple times as a TPC Member for international conferences, including IEEE ICC, IEEE GLOBECOM, and IEEE WCNC. He also regularly serves as a reviewer for more than ten international journals, including IEEE JSAC, TWC, TCOM, WCM, TIFS, TCCN, TVT, TITS, IOTJ, WCL, and CL.
